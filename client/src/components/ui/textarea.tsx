  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      ...
      >
        <textarea
          className={cn(
            `w-full min-h-[120px] border-none bg-background dark:bg-background text-text placeholder-purple-400 
            dark:text-text shadow-input rounded-md px-3 py-2 text-sm resize-none 
